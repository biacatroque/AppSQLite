...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table tbUsuario(cpf text primary key, senha text, nome text, email text, rg text, telefone text)");
    }
    ...
    public boolean insert(String nome, String senha, String email, String cpf, String rg, String telefone) {
